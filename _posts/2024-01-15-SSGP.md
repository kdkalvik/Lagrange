...
&= \log [\mathcal{N}(\mathbf{y} | \mathbf{K}_\mathbf{fb}\mathbf{K}_\mathbf{bb}^{-1}\mathbf{b}, \sigma^2I)]  - \frac{1}{2 \sigma^2} Tr [\mathbf{Q_f}] \\
\end{aligned}
$$
...
<details>
  ...
  $$
  \begin{aligned}
  x^\top M x - 2b^\top x = (x-M^{-1}b) M (x-M^{-1}b) - b^\top M^{-1} b
  \end{aligned}
  $$
...
Similarly we can simplify $E_1$ as follows:
...
&= \int p(\mathbf{a}|\mathbf{b}) \left[ \left( \cancel{-\frac{n}{2} \log(2\pi)} - \log |\mathbf{S_a}| - \frac{1}{2} Tr \left[ \mathbf{a}\mathbf{a}^\top \mathbf{S}^{-1}_\mathbf{a} - 2 \mathbf{a} \mathbf{m_a}^\top \mathbf{S}^{-1}_\mathbf{a} + \mathbf{m_a}\mathbf{m_a}^\top \mathbf{S}^{-1}_\mathbf{a} \right] \right) - \left( \cancel{-\frac{n}{2} \log(2\pi)} - \log |\mathbf{K_{aa}}| - \frac{1}{2} Tr \left[ \mathbf{a}^\top \mathbf{K}_\mathbf{aa}^{-1} \mathbf{a} \right] \right) \right] d\mathbf{a} \\
...
&= \frac{1}{2} \left(-\log \frac{|\mathbf{S_a}|}{|\mathbf{K_{aa}}|} - Tr \left[ \int p(\mathbf{a}|\mathbf{b}) \mathbf{a}\mathbf{a}^\top \mathbf{S}^{-1}_\mathbf{a}d\mathbf{a} - \int p(\mathbf{a}|\mathbf{b}) 2 \mathbf{a} \mathbf{m_a}^\top \mathbf{S}^{-1}_\mathbf{a}d\mathbf{a} + \int p(\mathbf{a}|\mathbf{b}) \mathbf{m_a}\mathbf{m_a}^\top \mathbf{S}^{-1}_\mathbf{a}d\mathbf{a} - \int p(\mathbf{a}|\mathbf{b}) \mathbf{a} \mathbf{a}^\top \mathbf{K}_\mathbf{aa}^{-1}d\mathbf{a} \right] \right) \\
...
&= \frac{1}{2} \left( \boldsymbol{\beta}^\top \left[\mathbf{K}_\mathbf{aa}^{-1}-\mathbf{S}^{-1}_\mathbf{a}\right]\boldsymbol{\beta} - 2 \boldsymbol{\beta}^\top\mathbf{S}^{-1}_\mathbf{a}\mathbf{m_a} \right) \left(-\log \frac{|\mathbf{S_a}|}{|\mathbf{K_{aa}}|} - Tr \left[\mathbf{m_a}\mathbf{m_a}^\top \mathbf{S}^{-1}_\mathbf{a} + \mathbf{Q_a}\left[\mathbf{K}_\mathbf{aa}^{-1}-\mathbf{S}^{-1}_\mathbf{a}\right]  \right] \right) \\

&= \frac{1}{2} \left( \boldsymbol{\beta}^\top \mathbf{D}^{-1}\boldsymbol{\beta} - 2 \boldsymbol{\beta}^\top\mathbf{S}^{-1}_\mathbf{a}\mathbf{m_a} \right) \left(- \log \frac{|\mathbf{S_a}|}{|\mathbf{K_{aa}}|} - \mathbf{m_a}^\top \mathbf{S}^{-1}_\mathbf{a} \mathbf{m_a} - Tr\left(\mathbf{D}^{-1}\mathbf{Q_a}\right)\right) \\

&= \frac{1}{2}  \left\{ \left( \boldsymbol{\beta} - \mathbf{D} \mathbf{S}^{-1}_\mathbf{a}\mathbf{m_a} \right)^\top \mathbf{D}^{-1} \left( \boldsymbol{\beta} - \mathbf{D} \mathbf{S}^{-1}_\mathbf{a}\mathbf{m_a} \right) - \left( \mathbf{m_a}^\top \mathbf{S}^{-1}_\mathbf{a} \mathbf{D} \mathbf{S}^{-1}_\mathbf{a}\mathbf{m_a} \right) \right\} \left(- \log \frac{|\mathbf{S_a}|}{|\mathbf{K_{aa}}|} - \mathbf{m_a}^\top \mathbf{S}^{-1}_\mathbf{a} \mathbf{m_a} - Tr\left(\mathbf{D}^{-1}\mathbf{Q_a}\right)\right) \\

&= \frac{1}{2}  \left\{ \left( \boldsymbol{\beta} - \mathbf{D} \mathbf{S}^{-1}_\mathbf{a}\mathbf{m_a} \right)^\top \mathbf{D}^{-1} \left( \boldsymbol{\beta} - \mathbf{D} \mathbf{S}^{-1}_\mathbf{a}\mathbf{m_a} \right) \right\} \left(- \log \frac{|\mathbf{S_a}|}{|\mathbf{K_{aa}}|} - \mathbf{m_a}^\top \mathbf{S}^{-1}_\mathbf{a} \mathbf{m_a} - Tr\left(\mathbf{D}^{-1}\mathbf{Q_a}\right) - \mathbf{m_a}^\top \mathbf{S}^{-1}_\mathbf{a} \mathbf{D} \mathbf{S}^{-1}_\mathbf{a}\mathbf{m_a} \right) \\

&= \log \mathcal{N}\left(\mathbf{D} \mathbf{S}^{-1}_\mathbf{a}\mathbf{m_a}; \boldsymbol{\beta}, \mathbf{D} \right) \left(- \log \frac{|\mathbf{S_a}|}{|\mathbf{K_{aa}}|} - \mathbf{m_a}^\top \mathbf{S}^{-1}_\mathbf{a} \mathbf{m_a} - Tr\left(\mathbf{D}^{-1}\mathbf{Q_a}\right) - \mathbf{m_a}^\top \mathbf{S}^{-1}_\mathbf{a} \mathbf{D} \mathbf{S}^{-1}_\mathbf{a}\mathbf{m_a} \right) \\
\end{aligned}
$$
